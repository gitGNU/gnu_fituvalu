...
struct fv_app_fulcrum_progression5_t
{
...
{
  struct fv_app_fulcrum_progression5_t *app = (struct fv_app_fulcrum_progression5_t *) data;
  four_square_to_nine_number_fulcrum_progression5 (progression, one, two, three, four);
  int count = count_squares_in_fulcrum_progression5 (progression);
  if (count > 4)
...
{
  struct fv_app_fulcrum_progression5_t *app = (struct fv_app_fulcrum_progression5_t *) state->input;
  char *end = NULL;
  switch (key)
    {
    case 'I':
...
int
fituvalu_fulcrum_progression5 (struct fv_app_fulcrum_progression5_t *app)
{
...
{
  struct fv_app_fulcrum_progression5_t app;
  memset (&app, 0, sizeof (app));
  app.incr = 1;
  app.display_record = display_nine_record;
  app.out = stdout;
  argp_parse (&argp, argc, argv, 0, 0, &app);
  return fituvalu_fulcrum_progression5 (&app);
}
