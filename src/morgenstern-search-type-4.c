  ...
  if (!infile)
  ...
  else
    {
      if (in_binary)
        {
          if (inmem)
            morgenstern_search_dual_binary_mem (in, infile, search_type_4, out);
          else
            morgenstern_search_dual_binary (in, infile, search_type_4, out);
        }
      else
        {
          if (inmem)
            morgenstern_search_dual_mem (in, infile, search_type_4, out);
          else
            morgenstern_search_dual (in, infile, search_type_4, out);
        }
    }
