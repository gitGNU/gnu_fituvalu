...
struct fv_app_reverse_fulcrum_progression1_t
{
...
{
  struct fv_app_reverse_fulcrum_progression1_t *app = (struct fv_app_reverse_fulcrum_progression1_t *) data;
  four_square_to_nine_number_reverse_fulcrum_progression1 (progression, one,
                                                           two, three, four);
  int count = count_squares_in_reverse_fulcrum_progression1 (progression);
  if (count > 4)
...
{
  struct fv_app_reverse_fulcrum_progression1_t *app = (struct fv_app_reverse_fulcrum_progression1_t *) state->input;
  char *end = NULL;
  switch (key)
    {
    case 'I':
...
int
fituvalu_reverse_fulcrum_progression1 (struct fv_app_reverse_fulcrum_progression1_t *app)
{
...
{
  struct fv_app_reverse_fulcrum_progression1_t app;
  memset (&app, 0, sizeof (app));
  app.incr = 1;
  app.display_record = display_nine_record;
  app.out = stdout;
  argp_parse (&argp, argc, argv, 0, 0, &app);
  return fituvalu_reverse_fulcrum_progression1 (&app);
