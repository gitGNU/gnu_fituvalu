...
main (int argc, char **argv)
{
  ...
  if (instream)
    small_read_square_and_run (instream, small_rev_4sq_progression1, check_progression, start, finish, stdout);
  else
    small_loop_and_run (small_rev_4sq_progression1, check_progression, start, finish, stdout);
